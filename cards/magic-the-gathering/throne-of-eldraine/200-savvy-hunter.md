...
held_for_lair: 0
bundles: []
tags_hub: ["hunter", "archer", "bow", "stag", "deer", "forest", "snow", "winter", "hood", "cloak", "fur", "huntress", "fairytale", "self-reliance", "provider"]
tags_filter: ["solo", "mid-shot", "three-quarter-facing", "female-figure", "action-mode", "creature-human", "creature-warrior", "black-magic", "green-magic", "multicolor-black-green", "sacrifice-payoff", "food-token", "card-draw"]
...
art_crop_image: cards/_images/magic-the-gathering/throne-of-eldraine/200-savvy-hunter--art.jpg
...
![200-savvy-hunter](../../_images/magic-the-gathering/throne-of-eldraine/200-savvy-hunter.png)
...
**Subject:** A human huntress in a fur-lined cloak drawing a bow in a snowy forest, with a stag fleeing through bare trees behind her

**Composition:** mid-shot, action, figures: solo, facing: three-quarter
**Setting:** forest, indeterminate, snow
**Foreground:** hooded huntress drawing a longbow, arrow nocked  *(palette: slate-blue, fur-brown, muted-green, skin-warm)*
**Background:** snowy birch forest with a fleeing stag among bare trees  *(palette: pale-blue, white, grey, birchbark-cream)*
**Mood / lighting:** other, ambient
**Emotion read:** focused, calm, predatory concentration
**Objects:** longbow, arrow, quiver, hooded-cloak, fur-trim
**Creatures:** stag, deer
**Iconography:** bow-and-arrow, hood
**Genre cues:** fantasy, fairytale, medieval
