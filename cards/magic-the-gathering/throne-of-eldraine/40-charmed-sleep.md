...
**Subject:** An armored knight slumped asleep on horseback beneath a rainbow arch, surrounded by onlookers in a fairground or tournament setting

**Composition:** mid-shot, narrative, figures: group, facing: three-quarter
**Setting:** other, day, clear
**Foreground:** Sleeping armored knight on a mount, head drooped  *(palette: blue, silver, steel-grey, white)*
**Background:** Rainbow arch, festival pavilions, crowd of onlookers, banners  *(palette: rainbow, red, tan, sky-blue, brown)*
**Mood / lighting:** peaceful, soft
**Emotion read:** deep enchanted sleep, body slack, head bowed
**Objects:** plate-armor, rainbow, banners, pavilion, saddle
**Creatures:** horse
