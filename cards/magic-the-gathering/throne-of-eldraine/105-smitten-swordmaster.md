...
held_for_lair: 0
bundles: []
tags_hub: ["knight", "sword", "monster", "beast", "fairy-tale", "slayer", "honor", "eldraine", "blue-armor", "duel", "aftermath"]
tags_filter: ["solo", "mid-shot", "narrative", "black-magic", "creature", "three-quarter"]
reference_image: cards/_images/magic-the-gathering/throne-of-eldraine/105-smitten-swordmaster.png
average_cost_paid: 0
market_price: 0.27
...
![105-smitten-swordmaster](../../_images/magic-the-gathering/throne-of-eldraine/105-smitten-swordmaster.png)

A knight in blue and gold plate armor stands in the foreground, holding a longsword at their side. The figure faces slightly toward the viewer with a composed expression. At their feet and partly filling the left portion of the frame is a large carcass — a scaled beast, its body dark and heavily textured with spines and claws visible. The background is misty and shadowed, with pink or purple ambient light at ground level. The scene reads as the aftermath of a duel or monster-slaying.

**Subject:** An armored knight standing over the body of a slain beast, sword in hand

**Composition:** mid-shot, narrative, figures: solo, facing: three-quarter
**Setting:** other, twilight, fog
**Foreground:** Armored knight with longsword; slain scaled beast in foreground  *(palette: blue, gold, dark grey-brown)*
**Background:** Dark misty environment; purple-pink ambient ground light  *(palette: dark grey, purple-pink, shadow)*
**Mood / lighting:** grim, ambient
**Emotion read:** calm resolve — knight stands composed over the fallen creature, no celebration
**Objects:** longsword, armor
**Creatures:** scaled beast
