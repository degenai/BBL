...
reference_image_source_url: https://cards.scryfall.io/png/front/2/3/23a4bac2-f6cb-4712-8510-a63657c43a5c.png?1589566341
mood: sublime
time_of_day: day
setting: forest
...
**Subject:** A maiden in a flowing red-pink gown leans close to and kisses a dark, vine-wrapped figure — a cursed/transformed lover — in a lush forest clearing, classic true-love's-kiss fairy-tale moment

**Composition:** mid-shot, narrative, figures: duo, facing: three-quarter
**Setting:** forest, day, calm
**Foreground:** maiden in red-pink gown kissing a dark vine-wrapped cursed figure  *(palette: crimson, rose-pink, black, deep-green, warm-skin)*
**Background:** lush green forest clearing with dense leaves, ivy, and dappled golden light  *(palette: forest-green, moss-green, gold, olive, shadow)*
**Mood / lighting:** sublime, soft
**Emotion read:** tender, intimate, devotional — eyes closed, leaning in
**Objects:** vines, ivy, flowing-gown
**Creatures:** cursed-figure
**Iconography:** kiss, vines-as-curse, transformation
**Genre cues:** fantasy, fairy-tale, storybook, romance
