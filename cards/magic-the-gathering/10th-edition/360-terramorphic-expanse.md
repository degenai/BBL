...
manual_review_reason: Set '10th Edition' did not match a known set code or the card was not in that set; fuzzy fallback returned art that may be from a different printing.
