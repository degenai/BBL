...
**Foreground:** two black-coated figures in mid-leap, pursuer with violet orb, target recoiling  *(palette: black, dark-grey, pink-violet)*
**Background:** gothic spired rooftops, dark orange window glow, night sky  *(palette: dark-orange, black, deep-grey)*
**Mood / lighting:** action, rim
**Emotion read:** predatory focus from pursuer, alarm and flight from target
**Objects:** magical-orb
