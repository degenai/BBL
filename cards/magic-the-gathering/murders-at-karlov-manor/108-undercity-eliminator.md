...
art_crop_image: cards/_images/magic-the-gathering/murders-at-karlov-manor/108-undercity-eliminator--art.jpg
art_crop_source_url: https://cards.scryfall.io/art_crop/front/a/6/a67a4c5e-215b-4f03-87f7-c1af4f9f0a63.jpg?1706241766
flavor_text: With their guild shunned for opening the doors to Phyrexia, some among the Golgari embraced their status as pariahs and took out their bitterness on all who crossed their paths.
oracle_text: When this creature enters, you may sacrifice an artifact or creature. When you do, exile target creature an opponent controls.
image_width: 745
image_height: 1040
image_quality: high
mood: grim
...
![108-undercity-eliminator](../../_images/magic-the-gathering/murders-at-karlov-manor/108-undercity-eliminator.png)

A figure with clearly visible serpentine hair — snakes in place of conventional hair, identifying this as a gorgon — looms over a heavily armored opponent who has fallen backward against a rubble-strewn wall. The gorgon holds a long-stemmed flower (a rose or similar bloom with a visible bud) and appears to be pressing it against the armored figure in an act of contemptuous violence. The setting is a subterranean tunnel or alley with rough stone walls and iron bars visible to the right. The palette is muted grey-olive with warm skin tones on the gorgon. The armored figure's bulky plate mail with horned helmet indicates a soldier or guard. A second flower or bloom lies to the lower right, suggesting it may have already been used as a weapon.

**Subject:** A gorgon with snake hair stands over a fallen armored figure, holding a flower stem as a weapon in a subterranean setting

**Composition:** mid-shot, action, figures: duo, facing: three-quarter
**Setting:** dungeon, ruined, indeterminate
**Foreground:** Gorgon with snake hair holding a flower stem, standing over a fallen armored figure against rubble  *(palette: olive-grey, warm skin, dark grey armor, muted green)*
**Background:** Subterranean stone tunnel with rubble, iron bars to the right  *(palette: grey, dark brown, black shadow)*
**Mood / lighting:** grim, ambient
**Emotion read:** contemptuous dominance from the gorgon; collapse and defeat from the armored figure
**Objects:** flower stem, rose, heavy plate armor, iron bars, rubble
**Creatures:** gorgon, snakes
