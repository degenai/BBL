...
held_for_lair: 0
bundles: []
tags_hub: ["undead", "plant", "roots", "golgari", "nature", "decay", "growth", "bioluminescence", "monster", "swamp", "rhizome", "regeneration"]
tags_filter: ["solo", "mid-shot", "action", "forward-facing", "multicolor-black-green", "creature-zombie", "undergrowth"]
...
art_crop_image: cards/_images/magic-the-gathering/guilds-of-ravnica/196-rhizome-lurcher--art.jpg
art_crop_source_url: https://cards.scryfall.io/art_crop/front/d/b/db9ce92b-79cc-4e26-b511-30ae8ea6a2a1.jpg?1572893793
flavor_text: \"The dead gain new purpose here. What is strange in the eyes of other guilds is harmonious in ours.\"\n—Devesh, Golgari shaman
oracle_text: Undergrowth — This creature enters with a number of +1/+1 counters on it equal to the number of creature cards in your graveyard.
image_width: 745
image_height: 1040
image_quality: high
mood: horror
...
![196-rhizome-lurcher](../../_images/magic-the-gathering/guilds-of-ravnica/196-rhizome-lurcher.png)

A large, lumbering creature fills the frame. Its body is a fusion of decaying organic matter, dense moss and root growth, and partially humanoid limbs — multiple arms or tendril-like appendages reach outward. Branching antler or root-like protrusions grow from the top of the figure, curling upward into a canopy. The body surface is covered in dense, dark growth suggesting moss, earth, and decomposing material. Glowing blue-white bioluminescent points are scattered across the figure's torso and branches. The background is a saturated green ambient glow, suggesting deep undergrowth. The creature's posture is active, reaching or lurching forward.

**Subject:** A massive plant-zombie hybrid creature with antler-like branches sprouting from its head and body, shambling forward in a murky green environment

**Composition:** mid-shot, action, figures: solo, facing: forward
**Setting:** forest, indeterminate
**Foreground:** Massive plant-zombie hybrid with branching antlers and bioluminescent patches  *(palette: dark olive, muted green, dark brown, pale blue-white glow)*
**Background:** Saturated green ambient glow  *(palette: deep green, dark olive)*
**Mood / lighting:** horror, ambient
**Emotion read:** relentless, driven by something other than intent — lurching, inevitable
