...
artist: Drew Baker
art_crop_image: cards/_images/magic-the-gathering/modern-horizons-3/96-gravedig--art.jpg
art_crop_source_url: https://cards.scryfall.io/art_crop/front/e/2/e2b054a9-7565-4fdd-b6a5-2786c5bb5b7e.jpg?1717011983
...
# Gravedig (Modern Horizons 3)

## Vision

![96-gravedig](../../_images/magic-the-gathering/modern-horizons-3/96-gravedig.png)

A stout figure in a dark coat is bent nearly double on a frost-dusted hillside, digging with a shovel. The figure's back is fully to the viewer, head down, knees in the dirt. The shovel arcs overhead with loose earth scattering into the cold air. The scene is lit by a diffuse white light source behind bare, leafless trees — suggesting a foggy or overcast day. Grave-markers or fence posts are faintly visible at the edges. The palette is muted grey, brown, and dull gold, with a painterly oil-sketch quality.

**Subject:** A hunched humanoid figure digging furiously into a sloped hillside, a shovel raised mid-swing with clods of earth flying

**Composition:** mid-shot, action, figures: solo, facing: away
**Setting:** other, indeterminate, fog
**Foreground:** A hunched figure in dark coat digging into the earth, shovel raised overhead with dirt flying  *(palette: brown, grey, tan)*
**Background:** Bare leafless trees, frost-dusted ground, diffuse white orb of light through mist  *(palette: pale grey, white, charcoal)*
**Mood / lighting:** grim, soft
**Emotion read:** intense physical exertion; frantic urgency implied by the body posture
