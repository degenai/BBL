...
reference_image: images/magic-the-gathering/invasion/no-num-smoldering-tar.png
average_cost_paid: 0
market_price: 0.17
...
![no-num-smoldering-tar](../../../images/magic-the-gathering/invasion/no-num-smoldering-tar.png)
...
**Foreground:** Armored ritualist with conical headdress holding a severed hand; standing braziers flank her emitting thick smoke columns  *(palette: dark brown, red-brown, black, dull silver)*
**Background:** Saturated deep red wall of light with vertical pale smoke pillars  *(palette: deep red, crimson, black smoke, grey)*
**Mood / lighting:** grim, ambient
**Emotion read:** imperious, ritualistic, calmly cruel
