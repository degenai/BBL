...
tags:
  ...
  - ip-pending
---
# Clawhauser - Donut Detective (Whispers in the Well)
...
**Subject:** Clawhauser from Disney's Zootopia — a chubby cheetah in a detective's vest and hat, holding a donut, surrounded by scattered papers

**Composition:** mid-shot, narrative, figures: solo, facing: forward
**Setting:** indoor, modern, indeterminate
**Foreground:** Chubby cheetah in detective hat and vest holding a pink donut, papers scattered around  *(palette: tan, grey, pink, yellow)*
**Background:** Warm amber-purple interior, blurred office-like setting  *(palette: amber, purple, brown)*
**Mood / lighting:** comedic, ambient
**Emotion read:** eager, enthusiastic, wide-eyed delight
**Objects:** donut, scattered papers, detective hat
**Creatures:** anthropomorphic cheetah, big-cat
**Food/drink:** donut
