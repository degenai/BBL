...
**Subject:** Small chibi-style figure in an enormous dark wizard hat with golden ornament, glowing white eyes beneath the brim, at a desk with a book and lantern

**Composition:** mid-shot, portrait, figures: solo, facing: forward
**Setting:** indoor, indeterminate
**Foreground:** Chibi wizard figure with enormous hat, glowing eyes, open book, lantern  *(palette: dark-blue, purple, gold, white)*
**Background:** Pale green wash  *(palette: pale-green, white)*
**Mood / lighting:** other, ambient
**Emotion read:** inscrutable, mysterious — face entirely hidden
