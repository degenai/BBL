...
- **Bottomless Pool // Locker Room** (DSK-43, uncommon U, Diana Franco art) — `{1}{U}` Room. The Bottomless Pool half bounces a creature on door-unlock; the Locker Room half is a tempo-piece. Two adjacent interior pool-locker-complex spaces — the bottomless deep-end and the changing room beside it — render the *summer-camp-horror water* visual register.
