...
held_for_lair: 0
bundles: []
tags_hub: ["saiyan", "god-form", "blue-aura", "warrior", "pride", "power", "transformation", "fighter", "divine", "tournament", "charge", "iconic"]
tags_filter: ["solo", "mid-shot", "forward-facing", "action-pose", "dbs-card", "suspected-ip", "super-saiyan-blue-form"]
...
# God Charge Vegeta (Galactic Battle)
...
**Subject:** Vegeta in Super Saiyan Blue form, hands raised forward gathering energy

**Composition:** mid-shot, action, figures: solo, facing: forward
**Setting:** void, indeterminate
**Foreground:** humanoid figure with blue upswept hair in dark suit with chest armor, both hands thrust forward  *(palette: blue, dark-navy, white)*
**Background:** exploding blue and electric-teal energy radiating outward  *(palette: blue, electric-teal, white)*
