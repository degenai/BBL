---
name: Boost Attack Piccolo
game: Dragon Ball Super
set: Galactic Battle
collector_number: BT1-045
rarity: Common
variance: Normal
grade: Ungraded
condition: Near Mint
...
reference_image_source_url: https://www.dbs-cardgame.com/images/cardlist/cardimg/BT1-045.png
image_width: 260
image_height: 363
image_quality: low
...
- [[piccolo-jr]] — Post-Nail-fusion Frieza-Saga power-up configuration anchor. The card depicts Piccolo Jr. in his canonical white-cape-and-turban combat uniform with palm-extended energy-projection pose — the result-state of the Nail-into-Piccolo permanent biological fusion that the BT4-070 Sacrifice card depicts the cause-event of. The card's trivia explicitly names this as carrying *"the clearest stewardship-register in the Z roster — a former antagonist whose entire late-series arc is the labor of raising another fighter"*, anchoring the canonical Gohan-mentor stewardship-register Piccolo Jr.'s arc renders across the franchise. `[Dragon Ball Wiki: Piccolo]` `[CBR: Everything You Need to Know About Gohan and Piccolo]` `[[piccolo-jr]]`
