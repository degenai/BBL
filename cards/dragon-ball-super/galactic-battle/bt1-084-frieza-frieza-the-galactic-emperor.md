---
name: Frieza // Frieza, The Galactic Emperor
game: Dragon Ball Super
set: Galactic Battle
collector_number: BT1-084
rarity: Uncommon
variance: Normal
grade: Ungraded
condition: Near Mint
...
held_for_lair: 0
bundles: []
tags_hub: ["emperor", "villain", "alien", "colonial-power", "ruler", "white-armor", "galactic", "tyrant", "bio-armor", "cosmic", "empire", "genocide"]
tags_filter: ["solo", "mid-shot", "portrait", "three-quarter", "anime", "leader-card"]
reference_image: cards/_images/dragon-ball-super/galactic-battle/bt1-084-frieza-frieza-the-galactic-emperor.png
average_cost_paid: 0
market_price: 0.15
market_price_as_of: 2026-05-14
date_added: 2026-05-14
last_seen: 2026-05-14
reference_image_source_url: https://www.dbs-cardgame.com/images/cardlist/cardimg/BT1-084.png
...
**Subject:** A white and purple bio-armored alien emperor figure in first form, depicted with a distinctive horned helmet, slim elongated build, and visible tail, standing in a commanding pose

**Composition:** mid-shot, portrait, figures: solo, facing: three-quarter
**Setting:** void, indeterminate
**Foreground:** White and purple armored alien emperor with horned helmet and tail  *(palette: white, purple, lavender)*
**Background:** Dark field with radiating yellow-white energy lines  *(palette: dark purple, black, yellow, white)*
