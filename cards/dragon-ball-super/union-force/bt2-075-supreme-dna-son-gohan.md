---
name: Supreme DNA Son Gohan
game: Dragon Ball Super
set: Union Force
collector_number: BT2-075
rarity: Common
variance: Normal
grade: Ungraded
condition: Near Mint
...
reference_image: cards/_images/dragon-ball-super/union-force/bt2-075-supreme-dna-son-gohan.png
average_cost_paid: 0
market_price: 0.1
market_price_as_of: 2026-05-24
date_added: 2026-05-16
last_seen: 2026-05-23
reference_image_source_url: https://www.dbs-cardgame.com/images/cardlist/cardimg/BT2-075.png
...
tags:
  ...
  - dbs
---
# Supreme DNA Son Gohan (Union Force)
...
**Subject:** Young Saiyan warrior in a charging stance with green energy aura

**Composition:** mid-shot, action, figures: solo, facing: forward
**Setting:** void, indeterminate
**Foreground:** young dark-haired humanoid figure in dark gi, charging forward with energy aura  *(palette: dark-gray, black, green, yellow)*
**Background:** green and yellow energy wash, abstract light burst  *(palette: green, yellow, white)*
**Mood / lighting:** action, rim
**Emotion read:** determined forward charge; full-body momentum
**Objects:** dark-gi
...
- [[son-gohan]] — fills the cohort's **Childhood / pre-Hyperbolic-Time-Chamber Android-Cell-Saga register (Cell-as-genetic-template thesis)** aspect slot — the corpus's first pre-HTC Gohan print (Bandai character-tag `Son Gohan: Childhood`, Android/Cell Saga era). The cohort body names this card as the anchor for the Cell-as-genetic-aggregator-and-Gohan-as-genetic-template thesis: Cell's "perfect" form absorbed the DNA of Goku, Vegeta, Piccolo, Frieza, and King Cold per canonical Z-canon lore, with Gohan's half-Saiyan / half-Earthling hybrid biology a key design target of that aggregation. The card title's "Supreme DNA" inversion reframes Gohan from Cell's intended victim-of-absorption into the source-of-supremacy — the genetic template from which the villain's perfection was assembled. The mechanical effect (energy-cost reduction conditional on 2+ Son Goku cards in your Drop Area) encodes the canonical family-lineage synergy at the rules-text level, linking Gohan's hybrid template to the paternal Goku component of his identity. Chronologically precedes the Cell-Saga teen (SS Full Power) aspect represented by BT2-074. `[cohort body: Childhood / pre-HTC Android-Cell-Saga register]` `[card frontmatter: name "Supreme DNA Son Gohan", BT2-075 Common Green]`
