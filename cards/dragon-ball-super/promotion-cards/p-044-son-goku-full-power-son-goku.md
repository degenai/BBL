---
name: Son Goku // Full Power Son Goku
game: Dragon Ball Super
set: Promotion Cards
collector_number: P-044
rarity: Promo
variance: Normal
grade: Ungraded
condition: Near Mint
...
held_for_lair: 0
bundles: []
tags_hub: ["super-saiyan", "power-up", "energy", "warrior", "orange-gi", "saiyan", "transformation", "golden-aura", "attack", "determination", "anime-action", "ki"]
tags_filter: ["solo", "wide", "action", "forward-facing", "male-figure", "anime"]
reference_image: cards/_images/dragon-ball-super/promotion-cards/p-044-son-goku-full-power-son-goku.png
average_cost_paid: 0
market_price: 1.64
market_price_as_of: 2026-05-14
date_added: 2026-05-14
last_seen: 2026-05-14
reference_image_source_url: https://www.dbs-cardgame.com/images/cardlist/cardimg/P-044.png
...
**Subject:** Son Goku in Super Saiyan form, dynamic leaping attack pose, orange gi

**Composition:** wide, action, figures: solo, facing: forward
**Setting:** void, indeterminate
**Foreground:** Super Saiyan fighter in orange gi leaping with fist extended, strong golden aura  *(palette: orange, gold, yellow, white)*
**Background:** Golden-yellow energy burst and light rays  *(palette: gold, yellow, orange, white)*
