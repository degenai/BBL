---
name: Blazing Spirit Son Goku
game: Dragon Ball Super
set: Colossal Warfare
collector_number: BT4-005
rarity: Common
variance: Normal
grade: Ungraded
condition: Near Mint
...
held_for_lair: 0
bundles: []
tags_hub: ["saiyan", "martial-arts", "fighter", "courage", "energy-aura", "orange-gi", "hero", "warrior", "rush-attack", "spirit", "youth"]
tags_filter: ["solo", "mid-shot", "forward-facing", "action", "male-figure", "red-magic", "battle-unit"]
reference_image: cards/_images/dragon-ball-super/colossal-warfare/bt4-005-blazing-spirit-son-goku.png
average_cost_paid: 0
market_price: 0.09
...
**Subject:** Son Goku in base form charging forward, fist raised, golden energy radiating from the body

**Composition:** mid-shot, action, figures: solo, facing: forward
**Setting:** void, indeterminate
**Foreground:** Goku in orange gi, fist raised, charging forward with energy aura  *(palette: orange, black, yellow)*
**Background:** Bright golden-white energy wash  *(palette: yellow, white, gold)*
