---
name: Umbral Invitation Towa
game: Dragon Ball Super
set: Colossal Warfare
collector_number: BT4-111
rarity: Common
variance: Normal
grade: Ungraded
condition: Near Mint
...
held_for_lair: 0
bundles: []
tags_hub: ["witch", "dark-magic", "villain", "female-warrior", "ritual", "corruption", "invitation", "chaos", "evil", "power", "time", "seduction"]
tags_filter: ["solo", "mid-shot", "action", "forward-facing", "female-figure", "anime", "sorcery"]
reference_image: cards/_images/dragon-ball-super/colossal-warfare/bt4-111-umbral-invitation-towa.png
average_cost_paid: 0
market_price: 0.11
...
**Subject:** A female figure in a dark bodysuit with long dark hair, arms extended outward, surrounded by swirling purple magical energy

**Composition:** mid-shot, action, figures: solo, facing: forward
**Setting:** void, indeterminate
**Foreground:** Female figure in dark bodysuit, long dark hair, arms extended, surrounded by purple magical energy  *(palette: dark-navy, black, purple)*
**Background:** Swirling dark purple and violet energy, dark dramatic background  *(palette: dark-purple, violet, black)*
