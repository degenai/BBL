...
**Subject:** Croagunk in a low crouched fighting stance

**Composition:** mid-shot, portrait, figures: solo, facing: three-quarter
**Setting:** urban, modern, indeterminate, clear
**Foreground:** crouched amphibian Pokemon on rough ground  *(palette: blue, black, orange, yellow, red)*
**Background:** pale-yellow urban buildings under a purple-pink sky  *(palette: pale-yellow, purple, pink, lavender)*
**Mood / lighting:** action, soft
**Emotion read:** alert, predatory, coiled to strike
**Creatures:** frog, toad, amphibian
