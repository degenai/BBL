...
tags_hub: ["monkey", "primate", "leaf", "grass", "meadow", "cheerful", "gentle", "healing", "friendship", "nature", "small-creature", "cute"]
tags_filter: ["solo", "mid-shot", "forward-facing", "portrait-mode", "creature-only", "grass-type", "basic-pokemon", "pokemon-card", "open-pose"]
...
oracle_text: Vine Whip (Grass) 10
mood: peaceful
time_of_day: day
setting: other
...
# Pansage (Burning Shadows)

## Vision

![12-147-pansage](../../_images/pokemon/burning-shadows/12-147-pansage.png)

> [!note] IP verified: **Pansage (Pokemon)**
> Confirmed via Bulbapedia character page (Pansage — Pokemon), Bulbapedia card page (Pansage — Burning Shadows 12), and the Elemental monkeys group article. Pansage's distinctive cream body, bipedal stance, and leafy head tuft are unambiguous species identifiers.

A cheerful illustration of Pansage standing upright on a sunny meadow with arms spread wide in an open, welcoming pose. The small bipedal creature has a cream-colored body, large expressive eyes, and a prominent leafy green tuft sprouting from the top of its head. The background is a simple bright outdoor scene with saturated green grass underfoot and a blue sky with scattered white clouds. The mood is light, warm, and approachable, consistent with the flavor-text note about Pansage sharing its head-leaf to relieve stress in other Pokemon.

**Subject:** Pansage, a small green simian Pokemon with a leafy head tuft, standing in a cheerful open-armed pose on a grassy field

**Composition:** mid-shot, portrait, figures: solo, facing: forward
**Setting:** other, day, clear
**Foreground:** Pansage standing upright with arms spread, on grass  *(palette: leaf-green, cream, tan, bright-green)*
**Background:** open grassy field under a blue sky with white clouds  *(palette: sky-blue, white, grass-green, yellow-green)*
**Mood / lighting:** peaceful, ambient
**Emotion read:** cheerful, welcoming, gentle
**Objects:** leaf-tuft
