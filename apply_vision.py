...
from bbl_schema import normalize_file  # type: ignore
...
def main() -> int:
    ...
    # so Obsidian's property panel renders correctly. Wave 92.5 chokepoint —
    # bbl_schema.normalize_file is the single source of truth for hygiene.
    normalize_file(args.card_md)
